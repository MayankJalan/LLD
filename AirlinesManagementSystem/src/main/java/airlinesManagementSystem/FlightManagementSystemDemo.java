...
import airlinesManagementSystem.seat.SeatType;
...
public class FlightManagementSystemDemo {
    public static void main(String[] args) {
        ...
        //Create Users
        LocalDateTime departureTime1=LocalDateTime.now().plusDays(3);
        ...
        //search Flight
        List<Flight> searchResults=airlineManagementSystem.searchFlights("New York", "London",LocalDate.now().plusDays(3));
