...
public class Splitwise {
    ...
    public void demo() {
        ...
        splits.add(split2);
        splits.add(split3);
        group.createExpense("Exp1001", splits,"Breakfast", 900, userController.getUser("U1001"), ExpenseSplitType.EQUAL );
        ...
        group.createExpense("Exp1002", splits2,"Lunch", 500, userController.getUser("U2001"),ExpenseSplitType.UNEQUAL);
