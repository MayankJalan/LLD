...
public class DigitalWalletServiceDemo {
    public static void main(String[] args) {
        DigitalWallet digitalWallet = DigitalWallet.getInstance();

        //create User
        User user1 = new User("U001", "Mayank Jalan", "mayank@example.com", "password123");
        User user2 = new User("U002", "Kush Kharb", "kush@example.com", "password456");
        ...
        digitalWallet.transferFunds(account1,account2,new BigDecimal("100"),Currency.USD);
